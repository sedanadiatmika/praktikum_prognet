...
<body>
    <form action="<?php echo e(url('admin/register')); ?>" method="POST" enctype="multipart/form-data">
...
<?php /**PATH C:\xampp\htdocs\praktikum_prognet - Copy\resources\views/admin/tampilanregister.blade.php ENDPATH**/ ?>